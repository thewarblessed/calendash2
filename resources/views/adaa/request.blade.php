        ...
        <div class="container-fluid py-4 px-5">
                                ...
                                <table class="table align-items-center mb-0" id="eventTable">
                                    <thead class="bg-gray-100">
                                        <tr>
                                            ...
                                            <th class="text-secondary text-xs font-weight-semibold opacity-7 ps-10">Status</th>
                                    ...
                                    <tbody id="eventBody">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <p class="text-sm text-dark font-weight-semibold mb-0">{{$event->event_date}}</p>
                                                
                                            </td>
                                            <td>
                                                <p class="text-sm text-dark font-weight-semibold mb-0">{{$event->start_time}}</p>
                                                
                                            </td>
                                            <td>
                                                <p class="text-sm text-dark font-weight-semibold mb-0">{{$event->end_time}}</p>
                                            ...
                                            <td >
                                                <button type="button" class="btn btn-info" style="width: 110px; height: 40px;">Approve</button>
                                                <button type="button" class="btn btn-danger" style="width: 110px; height: 40px;">Reject</button>
                                            </td>
            ...
            <div class="modal fade" id="createeventModal" tabindex="-1" role="dialog" aria-labelledby="createeventModalLabel" aria-hidden="true">
                ...
                <div class="modal-content">
                    ...
                    <h2 class="modal-title" id="createeventModalLabel" >Edit event</h2>
                    ...
                    <div class="modal-body">
                        <form id="eventUpdateForm" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                              ...
                              <input name="eventEditId" type="text" class="form-control" id="eventEditId" hidden>
                              <input name="eventEditName" type="text" class="form-control" id="eventEditName" required>
                            </div>
                            <div class="form-group">
                                <label for="exampleFormControlInput1">Description</label>
                                <input name="eventEditDesc" type="text" class="form-control" id="eventEditDesc" required>
                            </div>
                            <div class="form-group">
                                <label for="exampleFormControlInput1">Capacity</label>
                                <input name="eventEditCapacity" type="text" class="form-control" id="eventEditCapacity" required>
                            </div>
                            <div class="form-group">
                                <label for="exampleFormControlInput1">Upload Image</label>
                                <input name="eventEditImage" type="file" class="form-control" id="eventEditImage" required>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-white" data-bs-dismiss="modal">Close</button>
                                <button type="submit" class="btn btn-dark" id="eventUpdate">Save changes</button>
                            </div>
                        </form>
                    </div>
