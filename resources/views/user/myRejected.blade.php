                    ...
                    <div class="card border shadow-xs mb-4">
                        <div class="card-header border-bottom pb-0">
                            <div class="" style="text-align: center">
                                <div>
                                    <strong>
                                        <h3>Declined Request List</h3>
                                    </strong>
                                    <p class="text-sm">See information about My Declined Request</p>
                                </div>
                            </div>
                        </div>
                        @csrf
                        <input name="userRejectUserID" type="text" class="form-control" value="{{ Auth::user()->id }}"
                            id="userRejectUserID" hidden>
            ...
            buttons: [{
                ...
                },
                {
                    ...
                    customize: function(win) {
                        ...
                        var header = '<h4 style="margin-top: 30px; text-align: center; margin-right: 20;">Technological University of the Philippines</h4><br><h4 style="margin-top: 30px; text-align: center; margin-right: 20;">Declined Request List</h4>';
            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        ...
                        switch (data) {
                            ...
                            default:
                                roleName =
                                data; // Use the original value if not found in the switch statement
                                break;
                        }
                        return "<span style='color: black; font-weight: bold;'>" + roleName +
                            "</span>";
                    }
                },
                {
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        ...
                        return "<span style='color: black; font-weight: normal;'>" + remarks +
                            "</span>";
                    }
                },
            ],
