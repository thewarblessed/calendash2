<x-app-layout>
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <div class="container-fluid py-4 px-5">
                    ...
                    <div class="card border shadow-xs mb-4">
                        ...
                        <div class="card-body px-0 py-0">
                            ...
                            <div class="table-responsive p-0">
                                <table class="table align-items-center mb-0" id="pendingOutsidersTable">
                                    ...
                                    <tbody id="pendingUsersBody">
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle text-center text-sm">
                                                ...
                                                <button type="button" class="btn btn-dark btn-sm approveAccounts" data-id="{{ $pendingUser->user_id }}" data-bs-toggle="modal" data-bs-target="#approveOutsiderModal">Approve Account</button>
                                                @endif
                                            </td> 
                                        </tr>
                                        @endforeach
            ...
            <div class="modal fade" id="approveOutsiderModal" tabindex="-1" role="dialog" aria-labelledby="createVenueModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <form id="approveOutsiderForm" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="exampleFormControlInput1">Last Name:</label>
                                        <input name="outsiderId" type="text" class="form-control" id="outsiderApproveId" hidden>
                                        <p style="color: black" id="outsiderApproveLastname" ></p>
                                      </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="exampleFormControlInput1">First Name:</label>
                                        <p style="color: black" id="outsiderApproveFirstname" ></p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <p style="color: black" id="outsiderApproveRole" ></p>
                                </div>
                            </div>

                            <div class="form-group text-center">
                                <label for="exampleFormControlInput1">VALID ID PHOTO:</label>
                                <div class="d-flex justify-content-center">
                                    <div id="outsiderApproveTupIDPhoto"></div>
                                </div>
                            </div>

                            <div class="modal-footer">
                                <button type="button" class="btn btn-white" data-bs-dismiss="modal">Close</button>
                                {{-- <button type="submit" class="btn btn-danger" id="rejectOutsiderAccount">Reject account</button> --}}
                                <button type="submit" class="btn btn-dark" id="approveOutsiderAccount">Approve account</button>
                            </div>
                        </form>
                    </div>
