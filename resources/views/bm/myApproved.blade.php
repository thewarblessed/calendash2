                    ...
                    <div class="card border shadow-xs mb-4">
                        ...
                        <div class="card-body px-0 py-0">
                            <div class="table-responsive p-0">
                                <table class="table align-items-center mb-0" id="businessManagerApprovedTable">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="eventApprovalForm" enctype="multipart/form-data" method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="businessManagerApprovedUserID" type="text" class="form-control"
                                        value="{{ Auth::user()->id }}" id="businessManagerApprovedUserID" hidden>
...
<script>
    $(document).ready(function() {
        var id = $("#businessManagerApprovedUserID").val();
        console.log(id + 'user_id');
        var dataTable = $("#businessManagerApprovedTable").DataTable({
            ajax: {
