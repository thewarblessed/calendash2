                    ...
                    <div class="modal-body">
                        ...
                        <form id="eventApprovalForm" enctype="multipart/form-data" method="POST" action="{{ url('/api/request/approve/{id}') }}" >
                            ...
                            <div class="form-group">
                              ...
                              <input name="businessManagerApprovedUserID" type="text" class="form-control" value="{{ Auth::user()->id }}" id="businessManagerApprovedUserID" hidden>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $("#businessManagerApprovedTable").DataTable({
            ajax: {
