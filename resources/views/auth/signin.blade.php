                    ...
                    <div class="row">
                        <div class="col-xl-4 col-md-6 d-flex flex-column mx-auto">
                            <div class="card card-plain mt-8">
                                ...
                                <div class="card-body">
                                    <form role="form" class="text-start" method="POST" action="{{ route('login') }}" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="text-center">
                                            ...
                                            <a href="{{url('auth/google')}}" type="button" class="btn btn-white btn-icon w-100 mb-3">
                            ...
                            <div class="position-absolute w-40 top-0 end-0 h-100 d-md-block d-none">
                                <div class="oblique-image position-absolute fixed-top ms-auto h-100 z-index-0 bg-cover ms-n8"
                                    ...
                                    <div
                                        ...
                                        <h2 class="mt-3 text-dark font-weight-bold">Creating Spectacular School Experiences Together</h2>
