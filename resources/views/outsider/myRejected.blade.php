            ...
            <div class="row">
                <div class="col-12">
                    <div class="card border shadow-xs mb-4">
                        ...
                        @csrf
                        <input name="outsiderRejectUserID" type="text" class="form-control" value="{{ Auth::user()->id }}" id="outsiderRejectUserID" hidden>
...
<script>
    ...
    $(document).ready(function() {
        var id = $("#outsiderRejectUserID").val();
        console.log(id + 'user_idng nakallogin');
        $("#outsiderRejectsTable").DataTable({
            ajax: {
                url: "/api/rejected-event-outsider/" + id,
                method: "POST",
                dataSrc: "",
            },
            dom: 'Bfrtip',
         buttons: [{
                ...
                },
                {
                    ...
                    customize: function(win) {
                        ...
                        var header = '<h4 style="margin-top: 30px; text-align: center; margin-right: 20;">Technological University of the Philippines</h4><br><h4 style="margin-top: 30px; text-align: center; margin-right: 20;">Declined Events List</h4>';
