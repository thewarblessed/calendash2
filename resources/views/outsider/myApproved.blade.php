                    ...
                    <div class="card border shadow-xs mb-4">
                        ...
                        <div class="card-body px-0 py-0">
                            <div class="table-responsive p-0">
                                <table class="table align-items-center mb-0" id="outsiderApprovedTable">
                    ...
                    <div class="modal-body">
                        ...
                        <form id="eventApprovalForm" enctype="multipart/form-data" method="POST" action="{{ url('/api/request/approve/{id}') }}" >
                            ...
                            <div class="form-group">
                              ...
                              <input name="outsiderApprovedUserID" type="text" class="form-control" value="{{ Auth::user()->id }}" id="outsiderApprovedUserID" hidden>
...
<script>
    ...
    $(document).ready(function() {
        var id = $("#outsiderApprovedUserID").val();
        console.log(id + 'user_id');
        $("#outsiderApprovedTable").DataTable({
            ajax: {
                url: "/api/approved-event-outsider/" + id,
                method: "POST",
                dataSrc: "",
            },
            dom: 'Bfrtip',
            buttons: [{
                ...
                },
                {
                    ...
                    customize: function(win) {
                        ...
                        var header = '<h4 style="margin-top: 30px; text-align: center; margin-right: 20;">Technological University of the Philippines</h4><br><h4 style="margin-top: 30px; text-align: center; margin-right: 20;">Approved Events List</h4>';
