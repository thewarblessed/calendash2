<x-app-layout>
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <div class="container-fluid py-4 px-5">
                    ...
                    <div class="card border shadow-xs mb-4">
                        <div class="card-header border-bottom pb-0">
                            <div class="d-sm-flex align-items-center">
                                <div>
                                    <h6 class="font-weight-semibold text-lg mb-0">Organization Advisers</h6>
                                ...
                                <div class="ms-auto d-flex">
                                    ...
                                    <a type="button"
                                    href="{{ route('AdminCreateOrgAdviser') }}" class="btn btn-sm btn-dark btn-icon d-flex align-items-center me-2">
                                        ...
                                        <span class="btn-inner--text">Add Organization Advisers</span>
                                    </a>
                                </div>
                            </div>
                        </div>
                        <div class="card-body px-0 py-0">
                            ...
                            <div class="table-responsive p-0">
                                <table class="table align-items-center mb-0" id="orgAdviserTable">
                                    ...
                                    <tbody id="officialBody">
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle">
                                                <a href="javascript:;" class="text-secondary font-weight-bold editOrgAdviser"
                                            ...
                                            <td class="align-middle">
                                                <a href="javascript:;" class="text-secondary font-weight-bold deleteOrgAdviser"
            ...
            <div class="modal fade" id="editOrgAdviserModal" tabindex="-1" role="dialog" aria-labelledby="createVenueModalLabel" aria-hidden="true">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="orgAdviserUpdateForm" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                              <label for="exampleFormControlInput1">Name</label>
                              <input name="orgAdviserEditId" type="text" class="form-control" id="orgAdviserEditId" hidden>
                              <input name="orgAdviserEditName" type="text" class="form-control" id="orgAdviserEditName" required>
                            </div>
                            <div class="form-group">
                                <label for="exampleFormControlInput1">Email</label>
                                <input name="orgAdviserEditEmail" type="text" class="form-control" id="orgAdviserEditEmail" required>
                            </div>
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" class="btn btn-dark" id="orgAdviserUpdate">Save changes</button>
                            </div>
                        </form>
                    </div>
