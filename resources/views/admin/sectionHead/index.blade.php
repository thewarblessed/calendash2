<x-app-layout>
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <div class="container-fluid py-4 px-5">
                    ...
                    <div class="card border shadow-xs mb-4">
                        <div class="card-header border-bottom pb-0">
                            <div class="d-sm-flex align-items-center">
                                ...
                                <div class="ms-auto d-flex">
                                    ...
                                    <a type="button"
                                    href="{{ route('AdminCreateSectionHead') }}" class="btn btn-sm btn-dark btn-icon d-flex align-items-center me-2">
                                        ...
                                        <span class="btn-inner--text">Add Section Head</span>
                                    </a>
                                </div>
                            </div>
                        </div>
                        <div class="card-body px-0 py-0">
                            ...
                            <div class="table-responsive p-0">
                                <table class="table align-items-center mb-0" id="sectionHeadTable">
                                    <thead class="bg-gray-100">
                                        <tr>
                                            ...
                                            <th class="text-center text-secondary text-xs font-weight-semibold opacity-15">Section</th>
                                    ...
                                    <tbody id="officialBody">
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle text-center text-sm">
                                                <span class="text-sm text-dark font-weight-semibold mb-0">{{$official->section}}</span>
                                            </td>

                                            <td class="align-middle">
                                                <a href="javascript:;" class="text-secondary font-weight-bold editSectionHead"
                                            ...
                                            <td class="align-middle">
                                                {{-- <a href="javascript:;" class="text-secondary font-weight-bold deletesSectionHead"
            ...
            <div class="modal fade" id="editSectionHeadModal" tabindex="-1" role="dialog" aria-labelledby="createVenueModalLabel" aria-hidden="true">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="sectionHeadUpdateForm" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                              <label for="exampleFormControlInput1">Name</label>
                              <input name="sectionHeadEditId" type="text" class="form-control" id="sectionHeadEditId" hidden>
                              <input name="sectionHeadEditName" type="text" class="form-control" id="sectionHeadEditName" required>
                            </div>
                            <div class="form-group">
                                <label for="exampleFormControlInput1">Email</label>
                                <input name="sectionHeadEditEmail" type="text" class="form-control" id="sectionHeadEditEmail" required>
                            </div>
                            ...
                            {{-- <div class="form-group" style="display: ;" id="orgAdviserSelectOrgDiv">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" class="btn btn-dark" id="sectionHeadUpdate">Save changes</button>
                            </div>
                        </form>
                    </div>
