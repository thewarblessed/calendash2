        ...
        <div class="row">
          <div class="col-12">
            <div class="card border shadow-xs mb-4" style="padding: 50px">
              <div>
                <h3 style="text-align: center">CREATE SECTION HEAD</h3>
                {{-- method="POST" action="{{ route('storeVenue') }}" enctype="multipart/form-data" --}}
                <form role="form" id="sectionHeadForm" enctype="multipart/form-data">
                  @csrf
                  ...
                  <button type="submit" class="btn btn-primary btn-lg w-100" id="sectionHeadSubmit">SAVE</button>
                </form>
              </div>
            </div>
          </div>
